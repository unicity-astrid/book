...
my %title = (
  ...
  'capsule-model/designing-capsules'           => 'Designing Capsules',
...
my %rel = (
  ...
  'capsule-model/manifest-and-engines'         => ['capsule-model/imports-exports-resolution', 'capsule-model/lifecycle', 'capsule-model/designing-capsules', 'host-abi/capability-gating'],
  'capsule-model/imports-exports-resolution'   => ['capsule-model/manifest-and-engines', 'distribution/distros-and-store'],
  'capsule-model/lifecycle'                    => ['capsule-model/manifest-and-engines', 'capsule-model/designing-capsules', 'host-abi/packages-approval-identity-uplink'],
  'capsule-model/designing-capsules'           => ['foundations/kernel-is-dumb', 'bus/tools-as-ipc', 'host-abi/capability-gating'],
